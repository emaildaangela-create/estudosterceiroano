...
(function () {
  ...
  function renderTeoria(cap) {
    ...
    card.appendChild(criar('div','ideia-principal','<span>Ideia principal</span><p>'+explicarTermos(recorte.resumo)+'</p>'));
  ...
  function montarNovaExperiencia(raiz,cap,game,perfil,salvo) {
    ...
    var card=criar('section','jogo-card jogo-card--novo');
  ...
  function renderMemoria(stage,game,perfil,cap,salvo,registrar,verResultado) {
    ...
    cartas.forEach(function(carta){
      ...
      var b=criar('button','carta'+(achada?' carta--achada':''),
        '<span class="carta__verso" aria-hidden="true">?</span><span class="carta__frente">'+textoSeguro(carta.texto)+'</span>',
  ...
  function renderMaquina(stage,game,passo,perfil,concluir) {
    ...
    maquina.innerHTML='<div class="maquina__lado"><span>entra</span><strong class="maquina__base">'+textoSeguro(item.base)+'</strong></div>'+
      ...
      '<div class="maquina__lado"><span>sai</span><strong class="maquina__saida">?</strong></div>';
